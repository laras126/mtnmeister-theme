/*
 ...
 MyFonts Webfont Build ID 2904941, 2014-10-19T16:13:50-0400
 ...
 License: http://www.myfonts.com/viewlicense?type=web&buildid=2904941
 Licensed pageviews: 100,000
 Webfonts copyright: Copyright (c) 2014 by Daniel Hernandez &amp; Miguel Hernandez. All rights reserved.

 ? 2014 MyFonts Inc
*/
var protocol=document.location.protocol;"https:"!=protocol&&(protocol="http:");var count=document.createElement("script");count.type="text/javascript";count.async=!0;count.src=protocol+"//hello.myfonts.net/count/2c536d";var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if("undefined"==typeof woffEnabled)var woffEnabled=!0;var svgEnabled=0,woff2Enabled=1;
...
for(var fonts=[{fontFamily:"Texta-BookIt",url:wfpath+"2C536D_0"+suffix+"_0."+webfontType},{fontFamily:"Texta-Book",url:wfpath+"2C536D_1"+suffix+"_0."+webfontType},{fontFamily:"Texta-Heavy",url:wfpath+"2C536D_2"+suffix+"_0."+webfontType}],len=fonts.length,css="",i=0;i<len;i++){var format="svg#wf"==webfontType?'format("svg")':"ttf"==webfontType?'format("truetype")':"eot"==webfontType?"":'format("'+webfontType+'")',css=css+("@font-face{font-family: "+fonts[i].fontFamily+";src:url("+fonts[i].url+")"+
